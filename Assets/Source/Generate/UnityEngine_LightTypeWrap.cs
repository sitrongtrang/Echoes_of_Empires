...
public class UnityEngine_LightTypeWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("Pyramid", get_Pyramid, null);
		L.RegVar("Box", get_Box, null);
		L.RegVar("Tube", get_Tube, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_Pyramid(IntPtr L)
	{
		ToLua.Push(L, UnityEngine.LightType.Pyramid);
		return 1;
	}
	...
	{
		ToLua.Push(L, UnityEngine.LightType.Box);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_Tube(IntPtr L)
	{
		ToLua.Push(L, UnityEngine.LightType.Tube);
		return 1;
	}
