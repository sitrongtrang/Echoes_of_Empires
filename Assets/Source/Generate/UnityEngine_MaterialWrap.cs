...
public class UnityEngine_MaterialWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("rawRenderQueue", get_rawRenderQueue, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_rawRenderQueue(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Material obj = (UnityEngine.Material)o;
			int ret = obj.rawRenderQueue;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index rawRenderQueue on a nil value");
		}
	}
