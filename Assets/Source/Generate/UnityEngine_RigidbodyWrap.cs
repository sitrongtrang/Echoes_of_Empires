...
public class UnityEngine_RigidbodyWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("PublishTransform", PublishTransform);
		...
		L.RegVar("linearDamping", get_linearDamping, set_linearDamping);
		L.RegVar("angularDamping", get_angularDamping, set_angularDamping);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int PublishTransform(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.CheckObject<UnityEngine.Rigidbody>(L, 1);
			obj.PublishTransform();
			return 0;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_linearDamping(IntPtr L)
	{
		object o = null;
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index linearDamping on a nil value");
		}
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_angularDamping(IntPtr L)
	{
		object o = null;
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index angularDamping on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_linearDamping(IntPtr L)
	{
		object o = null;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_angularDamping(IntPtr L)
	{
		object o = null;
