...
public class UnityEngine_ResourcesWrap
{
	...
	static int InstanceIDsToValidArray(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<Unity.Collections.NativeArray<int>, Unity.Collections.NativeArray<bool>>(L, 1))
			{
				Unity.Collections.NativeArray<int> arg0 = StackTraits<Unity.Collections.NativeArray<int>>.To(L, 1);
				Unity.Collections.NativeArray<bool> arg1 = StackTraits<Unity.Collections.NativeArray<bool>>.To(L, 2);
				UnityEngine.Resources.InstanceIDsToValidArray(arg0, arg1);
				return 0;
			}
			// else if (count == 2 && TypeChecker.CheckTypes<System.ReadOnlySpan<int>, System.Span<bool>>(L, 1))
			// {
			// 	System.ReadOnlySpan<int> arg0 = StackTraits<System.ReadOnlySpan<int>>.To(L, 1);
			// 	System.Span<bool> arg1 = StackTraits<System.Span<bool>>.To(L, 2);
			// 	UnityEngine.Resources.InstanceIDsToValidArray(arg0, arg1);
			// 	return 0;
			// }
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Resources.InstanceIDsToValidArray");
			}
		}
		catch (Exception e)
		{
