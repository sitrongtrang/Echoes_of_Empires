...
public class UnityEngine_ShaderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SetGlobalRayTracingAccelerationStructure", SetGlobalRayTracingAccelerationStructure);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SetGlobalRayTracingAccelerationStructure(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);

			if (count == 2 && TypeChecker.CheckTypes<int, UnityEngine.Rendering.RayTracingAccelerationStructure>(L, 1))
			{
				int arg0 = (int)LuaDLL.lua_tonumber(L, 1);
				UnityEngine.Rendering.RayTracingAccelerationStructure arg1 = (UnityEngine.Rendering.RayTracingAccelerationStructure)ToLua.ToObject(L, 2);
				UnityEngine.Shader.SetGlobalRayTracingAccelerationStructure(arg0, arg1);
				return 0;
			}
			else if (count == 2 && TypeChecker.CheckTypes<string, UnityEngine.Rendering.RayTracingAccelerationStructure>(L, 1))
			{
				string arg0 = ToLua.ToString(L, 1);
				UnityEngine.Rendering.RayTracingAccelerationStructure arg1 = (UnityEngine.Rendering.RayTracingAccelerationStructure)ToLua.ToObject(L, 2);
				UnityEngine.Shader.SetGlobalRayTracingAccelerationStructure(arg0, arg1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Shader.SetGlobalRayTracingAccelerationStructure");
			}
		}
		catch (Exception e)
		{
