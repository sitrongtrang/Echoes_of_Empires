...
public class UnityEngine_AudioSourceWrap
{
	...
	static int get_resource(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.AudioSource obj = (UnityEngine.AudioSource)o;
			UnityEngine.Audio.AudioResource ret = obj.resource;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_resource(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.AudioSource obj = (UnityEngine.AudioSource)o;
			UnityEngine.Audio.AudioResource arg0 = (UnityEngine.Audio.AudioResource)ToLua.CheckObject<UnityEngine.Audio.AudioResource>(L, 2);
			obj.resource = arg0;
			return 0;
		}
		catch(Exception e)
