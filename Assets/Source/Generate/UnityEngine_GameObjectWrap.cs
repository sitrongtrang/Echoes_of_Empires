...
public class UnityEngine_GameObjectWrap
{
	...
	static int FindGameObjectsWithTag(IntPtr L)
	{
		try
		{
			...
			else if (count == 2)
			{
				...
				UnityEngine.GameObject.FindGameObjectsWithTag(arg0, arg1);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.GameObject.FindGameObjectsWithTag");
			}
		}
		catch (Exception e)
		{
	...
	static int CompareTag(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.TagHandle>(L, 2))
			{
				UnityEngine.GameObject obj = (UnityEngine.GameObject)ToLua.CheckObject(L, 1, typeof(UnityEngine.GameObject));
				UnityEngine.TagHandle arg0 = StackTraits<UnityEngine.TagHandle>.To(L, 2);
				bool o = obj.CompareTag(arg0);
				LuaDLL.lua_pushboolean(L, o);
				return 1;
			}
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.GameObject.CompareTag");
			}
		}
		catch (Exception e)
		{
	...
	static int SetGameObjectsActive(IntPtr L)
	{
		try
		{
			...
			// else if (count == 2 && TypeChecker.CheckTypes<System.ReadOnlySpan<int>, bool>(L, 1))
			// {
			// 	System.ReadOnlySpan<int> arg0 = StackTraits<System.ReadOnlySpan<int>>.To(L, 1);
			// 	bool arg1 = LuaDLL.lua_toboolean(L, 2);
			// 	UnityEngine.GameObject.SetGameObjectsActive(arg0, arg1);
			// 	return 0;
			// }
