...
public class UnityEngine_TimeWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("timeAsRational", get_timeAsRational, null);
		...
		L.RegVar("captureDeltaTimeRational", get_captureDeltaTimeRational, set_captureDeltaTimeRational);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_timeAsRational(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Time.timeAsRational);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_captureDeltaTimeRational(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Time.captureDeltaTimeRational);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_captureDeltaTimeRational(IntPtr L)
	{
		try
		{
			Unity.IntegerTime.RationalTime arg0 = StackTraits<Unity.IntegerTime.RationalTime>.Check(L, 2);
			UnityEngine.Time.captureDeltaTimeRational = arg0;
			return 0;
		}
		catch (Exception e)
		{
