...
public class UnityEngine_RenderTextureWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("ApplyDynamicScale", ApplyDynamicScale);
		...
		L.RegVar("useDynamicScaleExplicit", get_useDynamicScaleExplicit, set_useDynamicScaleExplicit);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_useDynamicScaleExplicit(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.RenderTexture obj = (UnityEngine.RenderTexture)o;
			bool ret = obj.useDynamicScaleExplicit;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index useDynamicScaleExplicit on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_useDynamicScaleExplicit(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			UnityEngine.RenderTexture obj = (UnityEngine.RenderTexture)o;
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			obj.useDynamicScaleExplicit = arg0;
			return 0;
		}
		catch(Exception e)
		{
