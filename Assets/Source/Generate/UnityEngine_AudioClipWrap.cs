...
public class UnityEngine_AudioClipWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.AudioClip), typeof(UnityEngine.Audio.AudioResource));
	...
	static int GetData(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<float[], int>(L, 2))
			{
				UnityEngine.AudioClip obj = (UnityEngine.AudioClip)ToLua.CheckObject(L, 1, typeof(UnityEngine.AudioClip));
	...
	static int SetData(IntPtr L)
	{
		try
		{
			...
			// else if (count == 3 && TypeChecker.CheckTypes<System.ReadOnlySpan<float>, int>(L, 2))
			// {
			// 	UnityEngine.AudioClip obj = (UnityEngine.AudioClip)ToLua.CheckObject(L, 1, typeof(UnityEngine.AudioClip));
			// 	System.ReadOnlySpan<float> arg0 = StackTraits<System.ReadOnlySpan<float>>.To(L, 2);
			// 	int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
			// 	bool o = obj.SetData(arg0, arg1);
			// 	LuaDLL.lua_pushboolean(L, o);
			// 	return 1;
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.AudioClip.SetData");
			}
		}
		catch (Exception e)
		{
