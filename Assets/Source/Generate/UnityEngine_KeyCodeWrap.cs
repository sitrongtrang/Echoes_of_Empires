...
public class UnityEngine_KeyCodeWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("WheelUp", get_WheelUp, null);
		L.RegVar("WheelDown", get_WheelDown, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_WheelUp(IntPtr L)
	{
		ToLua.Push(L, UnityEngine.KeyCode.WheelUp);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_WheelDown(IntPtr L)
	{
		ToLua.Push(L, UnityEngine.KeyCode.WheelDown);
		return 1;
	}
