...
public class UnityEngine_CameraWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("renderCloudsInSceneView", get_renderCloudsInSceneView, set_renderCloudsInSceneView);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_renderCloudsInSceneView(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Camera obj = (UnityEngine.Camera)o;
			bool ret = obj.renderCloudsInSceneView;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index renderCloudsInSceneView on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_renderCloudsInSceneView(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			UnityEngine.Camera obj = (UnityEngine.Camera)o;
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			obj.renderCloudsInSceneView = arg0;
			return 0;
		}
		catch(Exception e)
		{
