...
public class UnityEngine_AnimationWrap
{
	...
	static int get_updateMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Animation obj = (UnityEngine.Animation)o;
			UnityEngine.AnimationUpdateMode ret = obj.updateMode;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_updateMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Animation obj = (UnityEngine.Animation)o;
			UnityEngine.AnimationUpdateMode arg0 = (UnityEngine.AnimationUpdateMode)ToLua.CheckObject(L, 2, typeof(UnityEngine.AnimationUpdateMode));
			obj.updateMode = arg0;
			return 0;
		}
		catch(Exception e)
