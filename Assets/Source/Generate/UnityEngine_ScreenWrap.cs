...
public class UnityEngine_ScreenWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SetMSAASamples", SetMSAASamples);
		...
		L.RegVar("msaaSamples", get_msaaSamples, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SetMSAASamples(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 1);
			UnityEngine.Screen.SetMSAASamples(arg0);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int get_msaaSamples(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushinteger(L, UnityEngine.Screen.msaaSamples);
			return 1;
		}
		catch (Exception e)
		{
