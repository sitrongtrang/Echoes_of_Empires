...
public class UnityEngine_ColliderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("GeometryHolder", get_GeometryHolder, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_GeometryHolder(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Collider obj = (UnityEngine.Collider)o;
			UnityEngine.LowLevelPhysics.GeometryHolder ret = obj.GeometryHolder;
			ToLua.PushValue(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index GeometryHolder on a nil value");
		}
	}
