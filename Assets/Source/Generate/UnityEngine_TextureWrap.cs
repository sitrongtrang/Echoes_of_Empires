...
public class UnityEngine_TextureWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("graphicsTexture", get_graphicsTexture, null);
		L.EndClass();
	}
	...
	static int SetStreamingTextureMaterialDebugProperties(IntPtr L)
	{
		try
		{
			...
			{
				int arg0 = (int)LuaDLL.luaL_checknumber(L, 1);
				UnityEngine.Texture.SetStreamingTextureMaterialDebugProperties(arg0);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Texture.SetStreamingTextureMaterialDebugProperties");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_graphicsTexture(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Texture obj = (UnityEngine.Texture)o;
			UnityEngine.Rendering.GraphicsTexture ret = obj.graphicsTexture;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index graphicsTexture on a nil value");
		}
	}
